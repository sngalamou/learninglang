...
export class ItalianComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    indexRequest.onload = function() {
        ...
        word1 = res[179];
        ItalianComponent.word = word1;

        ItalianComponent.dataJson.sourceText = word1
      var data = JSON.stringify(ItalianComponent.dataJson);
      ...
      xhr.setRequestHeader("targetlanguage", "it");
  ...
  posting() {
    this.word1 = ItalianComponent.word;
    this.trans1 = ItalianComponent.trans;
  }
}
